                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-100 dark:border-zinc-800/50 shadow-inner flex flex-col items-center">
                            <label class="block text-[10px] font-black text-custom-primary dark:text-custom-primary uppercase tracking-[0.2em] mb-4">Área de Fotografía</label>
                            ...
                            <div class="mt-4 p-3 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 text-center w-full">
                                <p class="text-[9px] font-bold text-zinc-500 uppercase tracking-widest leading-relaxed">Formato: JPG / PNG</p>
                                <p class="text-[9px] font-mono text-zinc-400">Tamaño Máx: 2MB</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white dark:bg-zinc-900 p-8 rounded-2xl border border-zinc-100 dark:border-zinc-800/50 shadow-inner">
                            {{-- Título: Datos de Identidad Modificado --}}
                            ...
                            <div class="grid grid-cols-6 gap-x-5 gap-y-4">
                                ...
                                <div class="col-span-3">
                                    ...
                                    <x-text-input id="cedula" name="cedula" type="number" class="block w-full py-2 px-3 text-sm font-mono tracking-tight bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800 focus:ring-1 focus:ring-custom-primary" :value="old('cedula')" required placeholder="Sin puntos" />
                                ...
                                <div class="col-span-3">
                                    ...
                                    <x-text-input id="nombres" name="nombres" type="text" class="block w-full py-2 px-3 text-sm bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800" :value="old('nombres')" required />
                                </div>
                                ...
                                <div class="col-span-3">
                                    ...
                                    <x-text-input id="apellidos" name="apellidos" type="text" class="block w-full py-2 px-3 text-sm bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800" :value="old('apellidos')" required />
                                </div>
                                ...
                                {{-- Título: Información de Contacto Modificado --}}
                                ...
                                <div class="col-span-3">
                                    ...
                                    <x-text-input id="telefono" name="telefono" type="text" class="block w-full py-2 px-3 text-sm bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800" placeholder="0412-0000000" />
                                </div>
                                ...
                                <div class="col-span-3">
                                    ...
                                    <x-text-input id="email" name="email" type="email" class="block w-full py-2 px-3 text-sm bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800" placeholder="ejemplo@correo.com" />
                                </div>
                            </div>
                        </div>
                    </div>
